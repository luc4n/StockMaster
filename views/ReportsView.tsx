                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50 dark:bg-gray-800/50">
                                ...
                                <th className="p-6 text-xs font-black text-gray-400 uppercase tracking-widest text-right">Ação</th>
                            </tr>
                        </thead>
                                        ...
                                        <td className="p-6 text-right">
                                            {isStagnant && (
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 text-[10px] font-black uppercase tracking-widest rounded-lg hover:bg-rose-100 transition-all"
                                                >
                                                    Recolher
                                                </button>
                                            )}
                                            {!isStagnant && product.stock_internal > 100 && (
                                                <button
                                                    onClick={() => {
                                                        setSelectedProduct(product.id);
                                                        setIsTransferModalOpen(true);
                                                    }}
                                                    className="px-3 py-1.5 bg-primary/10 text-primary text-[10px] font-black uppercase tracking-widest rounded-lg hover:bg-primary/20 transition-all"
                                                >
                                                    Distribuir
                                                </button>
                                            )}
